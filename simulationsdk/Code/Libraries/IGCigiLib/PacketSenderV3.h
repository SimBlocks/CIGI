 ...
 *
 * @see sbio::cigi::ig::CCigiPacketSenderV3
 * @see sbio::cigi::ig::CCigiPacketSender
 * @see sbio::cigi::ig::CCigiImageGenerator
 */
#pragma once
#ifndef SIMBLOCKS_CIGI_LIB_PACKET_SENDER_V3_H
#define SIMBLOCKS_CIGI_LIB_PACKET_SENDER_V3_H
...
namespace sbio
{
  namespace cigi
  {
    ...
    {
      /**
       * @brief Serializes and sends IG-to-host packets using the CIGI 3.3 packet layout.
       */
      class CCigiPacketSenderV3 : public CCigiPacketSender
      {
      public:
        /**
         * @brief Constructs a packet sender for CIGI version 3.
         ...
         */
        CCigiPacketSenderV3(CCigiImageGenerator& imageGenerator, std::string hostIPAddress, int igToHostPort);

        /// @name `IPacketSender` overrides
        /// These methods serialize logical IG responses using the CIGI 3.3 packet layout.
        /// @{
        /**
         ...
         */
        virtual void SendCollisionDetectionSegmentNotificationResponse(const SCollisionDetectionSegmentNotification& response) override;
