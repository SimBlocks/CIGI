 ...
 */
#pragma once
#ifndef SIMBLOCKS_CIGI_LINE_OF_SIGHT_VECTOR_REQUEST_GEODETIC_EXTENDED_HANDLER_H
#define SIMBLOCKS_CIGI_LINE_OF_SIGHT_VECTOR_REQUEST_GEODETIC_EXTENDED_HANDLER_H
 ...
 */
class CLineOfSightVectorRequestGeodeticExtendedHandler : public CLineOfSightRequestHandler
{
public:
  /**
   ...
   */
  CLineOfSightVectorRequestGeodeticExtendedHandler(const sbio::cigi::SLineOfSightVectorRequestGeodeticExtended& lineOfSightRequest);
...
private:
  sbio::cigi::SLineOfSightVectorRequestGeodeticExtended m_Request;///< Geodetic vector request data
};
