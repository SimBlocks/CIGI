 ...
 */
#pragma once
#ifndef SIMBLOCKS_CIGI_LINE_OF_SIGHT_VECTOR_REQUEST_ENTITY_EXTENDED_HANDLER_H
#define SIMBLOCKS_CIGI_LINE_OF_SIGHT_VECTOR_REQUEST_ENTITY_EXTENDED_HANDLER_H
 ...
 */
class CLineOfSightVectorRequestEntityExtendedHandler : public CLineOfSightRequestHandler
{
public:
  /**
...
private:
  sbio::cigi::SLineOfSightVectorRequestEntityExtended m_Request;///< Entity vector request data
};
