...
bool CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::Handle()
{
  if (g_CigiLibGlobals.pEventMessenger == nullptr)
  {
    if (g_CigiLibGlobals.pLogger != nullptr)
    {
      g_CigiLibGlobals.pLogger->LogError("CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::Handle: IGCigiLib event messenger is not initialized.");
    }
    return false;
  }
...
const sbio::cigi::SLineOfSightRequest& CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::GetRequest() const
{
  return m_Request;
}

sbio::cigi::SLineOfSightRequest& CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::GetRequestRef()
{
  return m_Request;
}

bool CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::ResolveStartPoint(GeocentricCoordinates& point)
{
...
bool CLineOfSightSegmentRequestEntityToGeodeticExtendedHandler::ResolveEndPoint(GeocentricCoordinates& point)
{
