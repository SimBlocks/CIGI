...
copy /y "..\thirdparty\boost\stage\x64\lib\boost_filesystem-vc143-mt-gd-x64-1_88.dll" "%pathTo_SimulationSDK%"
copy /y "..\thirdparty\boost\stage\x64\lib\boost_thread-vc143-mt-gd-x64-1_88.dll" "%pathTo_SimulationSDK%"
copy /y "..\thirdparty\build\geographiclib\vs2022-x64\bin\Debug\GeographicLib_%d%.dll" "%pathTo_SimulationSDK%"
